      ...
      <body className="h-screen w-screen flex flex-col md:flex-row overflow-hidden bg-gray-50 text-gray-900">
        ...
        <nav className="bg-white border-t border-gray-200 md:border-t-0 md:border-r 
          ...
          <div className="flex flex-row md:flex-col p-2 gap-2 w-full h-full items-center md:items-stretch">
            ...
            {/* NIEUW: De Beheerknop - Exclusief voor desktop (md:flex) */}
            <Link
              href="/beheer/personen"
              className="hidden md:inline-flex items-center justify-start 
                         px-4 py-3 rounded-lg bg-slate-800 hover:bg-slate-900 text-white
                         font-medium transition-colors text-sm md:text-base mt-auto border border-slate-950"
            >
              ⚙️ Brontabellen Beheer
            </Link>
